...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: "Times New Roman", Times, serif; }
        ...
        input[type="email"], input[type="password"] { width: 100%; padding: 12px 14px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 15px; transition: border-color .15s, box-shadow .15s; }
        input[type="email"]:focus, input[type="password"]:focus { outline: none; border-color: var(--primary); box-shadow: 0 0 0 3px rgba(220, 38, 38, 0.12); }
        ...
        @media (max-width: 480px) { .card-body, .card-header { padding: 22px; } .topbar { flex-direction: column; align-items: flex-start; } .user-chip { width: 100%; justify-content: space-between; } }
    </style>
</head>
<body>
<?php if ($isLoggedIn): ?>
